        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <div className="glass-panel rounded-lg p-8">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm">
                Redshift Trading LLP maintains a Conflicts of Interest Policy designed to identify, manage,
            ...
            <div id="privacy" className="glass-panel rounded-lg p-8">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm">
                Redshift Trading LLP is committed to protecting your privacy. We collect and process personal
            ...
            <div id="terms" className="glass-panel rounded-lg p-8">
              ...
              <p className="text-muted-foreground leading-relaxed text-sm">
                ...
                website is the property of Redshift Trading LLP and is protected by copyright. You may not
                reproduce, distribute, or create derivative works from any content without prior written
                consent. Redshift Trading LLP reserves the right to modify these terms at any time.
              </p>
            </div>
          </div>
        </div>
